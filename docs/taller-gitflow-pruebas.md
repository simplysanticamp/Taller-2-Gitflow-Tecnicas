...
| ------------- | ------------------- | -------------- | ---------------------------------------------------------------------------- | -------- | -------------- | ---------------------------- |
| RF-02         | Partición de clases | CP-01          | Código de 8 caracteres que inicia con “E” y contiene 7 números               | Válida   | E1234567     | El sistema acepta el código  |
| RF-02         | Partición de clases | CP-02          | Código que no cumple el formato (longitud incorrecta o caracteres inválidos) | Inválida | E123         | El sistema rechaza el código |
